...
def is_correct_required_places(required_places, club, competition) \
        -> (bool, str):
...
def purchase_places():
    ...
    is_correct, message = is_correct_required_places(required_places,
                                                     club,
                                                     competition)
    ...
    if is_correct:
        if not check_competition_date(competition):
            # should not happen,
            # website prevent from accessing booking page on past competition
            message = "You can't book in a past competition"
        else:
